    ...
    try {
      if (event.message.text.slice(0, 4) === 'post') {
        ...
        if (textAry.length === 3) {
          ...
          var targetTime = new Date(2019, parseInt(textAry[2].slice(0, 2))-1, parseInt(textAry[2].slice(2, 4)), parseInt(textAry[2].slice(4, 6)), parseInt(textAry[2].slice(6, 8))).toLocaleString('zh-TW', { timeZone: 'Asia/Taipei' })
